package Graph.UndirectedGraph.Traversal.ValidPath;

import java.util.*;

/**
 * This class provides two methods (DFS & BFS) to determine whether a valid path exists between two nodes in an undirected graph.
 */
